  ...
  return (
    <div className="h-full w-full">
      <Resizable
        ...
        className=" flex flex-col gap-1 relative w-full h-full  min-w-full min-h-full max-h-full bg-slate-500 border-dashed border-4 bg-opacity-30 border-red-800 p-2 "
      >
